...
def test_groups():
    ...
    params = {'random_seed': 1, 'indy_var': 'fcst_lead',
              ...
              'series_val_1': {'model': ['GTS+RAIN3mm,GTS+RAIN4mm', 'GTS+RAIN50p,GTS+RAIN5mm']},
              'series_val_2': {},
    ...
    assert input_data.loc[(input_data['model'] == 'GTS+RAIN3mm,GTS+RAIN4mm')
                          & (input_data['fcst_lead'] == 120000)]['stat_value'].item() == -1.4384707
    assert input_data.loc[(input_data['model'] == 'GTS+RAIN50p,GTS+RAIN5mm')
